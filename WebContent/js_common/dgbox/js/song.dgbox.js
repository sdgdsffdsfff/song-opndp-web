...
jQuery.extend(Dgbox, {
    ...
    information: function(message, autoClose) {
    	autoClose = autoClose || 2000;
    	var body = jQuery('<div class="information"></div>').html(message);
    	var box = new Dgbox(body, {});
    	window.setTimeout(function() {box.close()}, autoClose);
    },
